...
<html>
  <head>
	...
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=WY0LNZXMqTGG5dCw8TE1cp3o"></script>	    
    <link href="PlugIn/jQuery/css/redmond/jquery-ui-1.10.2.custom.min.css" rel="stylesheet" type="text/css" />
	<style type="text/css">
...
map.centerAndZoom(new BMap.Point(104.072381,30.663549), 11);
...
function addInfoWindow(marker,poi,index){
    ...
    infoWindowHtml.push('</tr>');
    infoWindowHtml.push('<tr>');
    infoWindowHtml.push('<td colspan=2><button style="width:100%" >设为终点</button></td>');
    infoWindowHtml.push('</tr>');
