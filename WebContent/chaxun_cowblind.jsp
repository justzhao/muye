...
<%
	...
	*/
	...
	txt += "<div><table width=\"100%\" id=\"table-custom-2\" data-mode=\"columntoggle\" class=\"ui-body-d ui-shadow table-stripe ui-responsive\" data-column-btn-theme=\"b\" data-column-btn-text=\"选择要查看的列\" data-column-popup-theme=\"a\"><tr><th colspan=\"2\"><span class=\"STYLE7\"> "
			+ (cowID == null ? "":cowID) 
			//+ "盲乳头信息</th></tr><tr class=\"ui-bar-d\"><th>检测日期</th><th>所在牧场</th><th>当前牛舍</th><th>牛只类别</th><th>泌乳状态</th><th>繁殖状态</th><th>当前胎次</th><th>左前乳区</th><th>左前标记日期</th><th>左前标记人</th>"
			//+ "<th>右前乳区</th><th>右前标记日期</th><th>右前标记人</th><th>左后乳区</th><th>左后标记日期</th><th>左后标记人</th><th>右后乳区</th><th>右后标记日期</th><th>右后标记人</th><th>是否离场</th><th>离场日期</th></tr>";
			+ "盲乳头信息 </span></th></tr><tr class=\"ui-bar-d\"><th width=\"30%\">栏目</th><th width=\"70%\">数据</th></tr>";
			
	if (cowID != null) {

		txt += Services.getCowBlindInfoHTML(cowID);
